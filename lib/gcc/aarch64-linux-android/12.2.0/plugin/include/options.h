...
enum opt_code
{
  ...
  OPT_list = 1772,                           /* -list */
  OPT_mabi_ = 1773,                          /* -mabi= */
  OPT_mandroid = 1774,                       /* -mandroid */
  OPT_march_ = 1775,                         /* -march= */
  OPT_mbig_endian = 1776,                    /* -mbig-endian */
  OPT_mbionic = 1777,                        /* -mbionic */
  OPT_mbranch_protection_ = 1778,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1779,                       /* -mcmodel= */
  OPT_mcpu_ = 1780,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1781,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1782,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1783,             /* -mgeneral-regs-only */
  OPT_mglibc = 1784,                         /* -mglibc */
  ...
  OPT_muclibc = 1805,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1806,             /* -mverbose-cost-dump */
  OPT_n = 1807,                              /* -n */
  OPT_name_sort = 1808,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1809,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1810,              /* -no-integrated-cpp */
  OPT_no_pie = 1811,                         /* -no-pie */
  OPT_nocpp = 1812,                          /* -nocpp */
  OPT_nodefaultlibs = 1813,                  /* -nodefaultlibs */
  OPT_nolibc = 1814,                         /* -nolibc */
  OPT_nophoboslib = 1815,                    /* -nophoboslib */
  OPT_nostartfiles = 1816,                   /* -nostartfiles */
  OPT_nostdinc = 1817,                       /* -nostdinc */
  OPT_nostdinc__ = 1818,                     /* -nostdinc++ */
  OPT_nostdlib = 1819,                       /* -nostdlib */
  OPT_o = 1820,                              /* -o */
  OPT_objects = 1821,                        /* -objects */
  OPT_p = 1822,                              /* -p */
  OPT_pass_exit_codes = 1823,                /* -pass-exit-codes */
  /* OPT_pedantic = 1824, */                 /* -pedantic */
  OPT_pedantic_errors = 1825,                /* -pedantic-errors */
  OPT_pg = 1826,                             /* -pg */
  OPT_pie = 1827,                            /* -pie */
  OPT_pipe = 1828,                           /* -pipe */
  OPT_posix = 1829,                          /* -posix */
  ...
  OPT_profile = 1842,                        /* -profile */
  OPT_pthread = 1843,                        /* -pthread */
  OPT_quiet = 1844,                          /* -quiet */
  OPT_r = 1845,                              /* -r */
  OPT_rdynamic = 1846,                       /* -rdynamic */
  ...
  OPT_time = 1932,                           /* -time */
  OPT_time_ = 1933,                          /* -time= */
  OPT_tno_android_cc = 1934,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1935,                 /* -tno-android-ld */
